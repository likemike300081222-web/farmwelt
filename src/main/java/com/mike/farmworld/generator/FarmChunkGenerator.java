...
public class FarmChunkGenerator extends ChunkGenerator {
    ...
    // Höhen relativ zur Weltbasis (funktioniert für 1.18+ mit negativer Höhe)
    ...
    public boolean shouldGenerateCaves() {
        // Höhlen sorgen für sinnvolle Dungeon-Verstecke im Untergrund
        return true;
    }
    ...
    public boolean shouldGenerateDecorations() {
        return false; // wir übernehmen Vegetation selbst über die Populatoren
    }
    ...
    public boolean shouldGenerateStructures() {
        return false; // keine Vanilla-Strukturen, wir haben eigene Dungeons
    }
